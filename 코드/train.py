...
def _main():
    ...
    anchors_path = 'keras-yolo3/yolo_anchors.txt'
    ...
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='keras-yolo3/weights.h5')
    else:
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='keras-yolo3/weights.h5') # make sure you know what you freeze
